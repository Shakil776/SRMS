<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
            <img src="http://placehold.it/90/c2c2c2?text=User" alt="Shakil" class="img-circle profile-img">
            <h6 class="title">
                <?php 
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Student Batch</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-batch.php"><i class="fa fa-bars"></i> <span>Create Batch</span></a></li>
                        <li><a href="manage-batch.php"><i class="fa fa fa-server"></i> <span>Manage Batch</span></a></li>
                    </ul>
                </li>
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="manage-semester.php"><i class="fa fa fa-server"></i> <span>Manage Semester</span></a></li>
