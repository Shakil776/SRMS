<?php
    ...
    if (strlen($_SESSION['alogin']) == '') {   
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO tblbatch(batchname, department) VALUES(:batchname, :department)";
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form action="" method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="batchname" class="form-control" required="required" id="success">
