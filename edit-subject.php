 ...
 <?php
    ...
    if($query->rowCount() > 0) {
        foreach($results as $result){ ?>                                               
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="subjectname" value="<?php echo $result->SubjectName;?>" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Code</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcode" class="form-control" value="<?php echo $result->SubjectCode;?>"  id="default" placeholder="Subject Code" required="required">
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
