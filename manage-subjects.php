...
<td>
<a href="edit-subject.php?subjectid=<?php echo $result->id; ?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
<a href="manage-subjects.php?delete=<?php echo $result->id; ?>" onclick="return confirm('Are You sure to delete this?');" ><i class="fa fa-trash-o" title="Delete Record"></i> </a>
