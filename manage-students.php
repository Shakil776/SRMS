...
<td>
<a href="edit-student.php?stid=<?php echo $result->id; ?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
<a href="manage-students.php?delete=<?php echo $result->id; ?>" onclick="return confirm('Are You sure to delete this?');" ><i class="fa fa-trash-o" title="Delete Record"></i> </a>
