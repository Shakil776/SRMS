<?php
    ...
    if(strlen($_SESSION['alogin']) == ""){   
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "SELECT tblsubjects.SubjectName,tblsubjects.id FROM tblsubjectcombination JOIN  tblsubjects ON  tblsubjects.id=tblsubjectcombination.SubjectId WHERE tblsubjectcombination.SemesterId=:sid order by tblsubjects.SubjectName";
            $stmt = $conn->prepare($sql);
            $stmt->execute(array(':sid' => $semesterid));
            $sid1 = array();
            ...
            for($i=0; $i<count($mark); $i++){
                ...
                $sql = "INSERT INTO tblresult(StudentId,BatchId,DepartmentId,SemesterId,SubjectId,marks) VALUES(:studentid,:batchid,:departmentid,:semesterid,:sid,:marks)";

                $query = $conn->prepare($sql);
                $query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
                $query->bindParam(':batchid',$batchid,PDO::PARAM_STR);
                $query->bindParam(':departmentid',$departmentid,PDO::PARAM_STR);
                $query->bindParam(':semesterid',$semesterid,PDO::PARAM_STR);
                            ...
                            <div class="col-md-12">
                                ...
                                <form class="form-horizontal" method="post">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="batch" class="form-control clid" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="department" class="form-control clid" required="required">
                                	...
                                	<div class="form-group">
                                		...
                                		<div class="col-sm-10">
                                			<select name="semester" class="form-control clid" id="semesterid" onChange="getStudent(this.value);" required="required">
