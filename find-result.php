            ...
            <div class="login-bg-color bg-black-300">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="panel-body p-20">
                                <form id="myForm" action="result.php" method="post">
                                    <div class="form-group">
                                        <label for="rollid">Enter your Roll Number</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Roll Number" autocomplete="off" name="rollid" required="on" />
                                    </div>

                                    <div class="form-group">
                                        <label for="default" class="control-label">Batch</label>
                        ...
                        <!-- /.panel -->
                        <div class="col-sm-12">
                            <p class="text-muted text-center"><small>Copyright © Legends of DIU</small></p>
                        </div>
                    </div>
